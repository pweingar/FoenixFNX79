...
;;
            ...
            .include "c256_sections.asm"
            .include "c256_text.asm"
...
start       sei
            ...
            ; Set the data bank register to $af (I/O bank)
            lda #$af
            pha
            plb
            .databank $af
...
not_caps    ; Any other character, print it, and repeat
...
wait        lda STATUS_PORT
            ...
            ; Write the data to the keyboard
send        pla
            sta KBD_DATA_BUF
